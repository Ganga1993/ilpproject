<%@ Page Title="" Language="C#" MasterPageFile="~/PlacementConsultant.Master" AutoEventWireup="true" CodeBehind="PCHome.aspx.cs" Inherits="Team2.WebForm18" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">HR Tips</h3>s
                    </div>
                    <div class="panel-body">
                        <div class="col-lg-12 embed-responsive embed-responsive-16by9">
